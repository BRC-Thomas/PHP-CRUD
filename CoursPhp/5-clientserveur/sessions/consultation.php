...
<body>
  ...
  <p>Pour récupérer la session, il faut à nouveau faire appel à la fonction <a
      href="http://php.net/manual/fr/function.session-start.php"><code>session_start()</code></a> avant d'écrire le
    moindre code HTML.</p>
  ...
  <?php
        ...
        ?>
  <h2>La variable superglobale
    <code><a href="http://php.net/manual/fr/reserved.variables.session.php">$_SESSION</a></code>
  </h2>
  <?php
  ...
  <?php
        afficheCode(['filterInput.php'], false, 'filterInput.php',false, 'Ne fonctionne pas avec la version actuelle (PHP8.2)');
        ?>
