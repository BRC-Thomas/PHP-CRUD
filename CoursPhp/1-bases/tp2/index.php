...
<body>
  ...
  <section class="enonce">Créer un tableau multidimensionnel associatif dont les clés sont des noms de personnes et les
    valeurs des tableaux indicés contenant le prénom, la ville de résidence et l'âge de la personne.</section>
  <?php
  ...
  <section class="enonce">Créer un tableau multidimensionnel associatif dont les clés sont des noms de personnes et les
    valeurs des tableaux associatifs dont les clés sont le prénom, la ville de résidence et l'âge de la personne avec
    une série de valeurs associées.</section>
  <?php
  ...
  <section class="enonce">Utiliser une boucle foreach pour lire les tableaux des exercices 1 et 2 et afficher les
    informations avec le format suivant :
    <ul>
      <li>Element dupont<ul>
          <li>élément 0 : gérard </li>
          <li>élément 1 : paris </li>
          <li>élément 2 : 67 </li>
        </ul>
      </li>
      <li>Element badin<ul>
          <li>élément 0 : aurélie </li>
          <li>élément 1 : nantes </li>
          <li>élément 2 : 31 </li>
        </ul>
      </li>
    </ul>
  ...
  <section class="enonce">Créer un tableau contenant une liste d'adresses e-mail. Extraire le nom de serveur de ces
    données, puis réaliser des statistiques sur les occurrences de chaque fournisseur d'accès.</section>
  <?php
  ...
  <section class="enonce">Créer un tableau d'entiers variant de 1 à 63, puis à partir de celui ci un autre tableau de
    nombres variant de 0 à 6.3. Créer ensuite un tableau associatif dont les clés X varient de 0 à 6.3 et dont les
    valeurs sont sin(X). Afficher ce tableau dans un tableau HTML.</section>
  <?php
